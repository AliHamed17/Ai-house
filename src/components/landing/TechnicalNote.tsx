  ...
  return (
    <section className="mx-auto max-w-4xl px-6 py-16">
      <div className="rounded-3xl border border-olive/30 bg-olive/5 p-6">
        ...
        <p className="mt-3 text-sm text-charcoal/75">
          The room marked MAMAD is an Israeli protected room. Its door, window, and required clearances are fixed in
          this model and must never be altered, concealed, or obstructed by any design variant shown here. A real
          protected room also requires a dedicated ventilation feature, which this evidence-derived model does not
          separately represent; any real modification requires compliance with the approved plan and applicable
          regulations.
        </p>
      </div>
    </section>
